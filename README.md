...
| shouldExtractValuesFromInterfaces | boolean                    | If set to true, interfaces declarations are going to be converted to docgen objects format. https://github.com/styleguidist/react-docgen-typescript#parseroptions                     |
